...
public class ProvidersTypesLocators {
    WebDriver driver;
    public ProvidersTypesLocators(WebDriver driver)
    {
        this.driver=driver;
    }
    ...
    {
        WebElement show_entities = driver.findElement(By.cssSelector("select[aria-controls=\"service_types\"]"));
    ...
    {
        WebElement next_button = driver.findElement(By.cssSelector("a[aria-controls=\"service_types\"]"));
        return next_button;
    }
